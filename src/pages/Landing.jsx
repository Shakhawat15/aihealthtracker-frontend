...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      <header className="md:max-w-6xl lg:max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
      ...
      <section className="md:max-w-6xl lg:max-w-7xl mx-auto px-6 pt-10 md:pt-16 pb-16">
      ...
      <section className="md:max-w-6xl lg:max-w-7xl mx-auto px-6 py-16 border-t divider">
      ...
      <section className="md:max-w-6xl lg:max-w-7xl mx-auto px-6 py-16">
      ...
      <footer className="md:max-w-6xl lg:max-w-7xl mx-auto px-6 py-8 text-center text-xs text-faint border-t divider">
